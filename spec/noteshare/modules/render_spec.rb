...
describe Render do
  ...
  before do
    ...
    image = Image.new(title: 'Shell', filename: 'Joordens_Trinil_engravedshell-640x907-original.jpg', url: 's3.amazonaws.com/vschool/noteshare_images/Joordens_Trinil_engravedshell-640x907-original.jpg')
...
=end
 it 'rewrites media urlst' do
   ...
   r.convert.must_equal(expected_tag)
