...
module Node
  class Application < Lotus::Application
    configure do
      ...
      #
      # sessions :cookie, secret: ENV['NODE_SESSIONS_SECRET']
      ...
      #
      layout :application # It will load Node::Views::ApplicationLayout
      ...
      # Configure the code that will yield each time Node::Action is included
      ...
      # Configure the code that will yield each time Node::View is included
      # This is useful for sharing common functionality
      #
