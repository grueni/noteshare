...
module Test
  class Application < Lotus::Application
    configure do
      ...
      #
      # sessions :cookie, secret: ENV['TEST_SESSIONS_SECRET']
      ...
      #
      layout :application # It will load Test::Views::ApplicationLayout
      ...
      # Configure the code that will yield each time Test::Action is included
      ...
      # Configure the code that will yield each time Test::View is included
      # This is useful for sharing common functionality
      #
