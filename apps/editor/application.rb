...
module Editor
  class Application < Lotus::Application
    configure do
      ...
      #
      # sessions :cookie, secret: ENV['EDITOR_SESSIONS_SECRET']
      ...
      #
      layout :application # It will load Editor::Views::ApplicationLayout
      ...
      # Configure the code that will yield each time Editor::Action is included
      ...
      # Configure the code that will yield each time Editor::View is included
      # This is useful for sharing common functionality
      #
