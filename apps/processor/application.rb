...
module Processor
  class Application < Lotus::Application
    configure do
      ...
      #
      layout :application # It will load Processor::Views::ApplicationLayout
      ...
      # Configure the code that will yield each time Processor::Action is included
      ...
      # Configure the code that will yield each time Processor::View is included
      # This is useful for sharing common functionality
      #
