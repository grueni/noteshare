...
module ImageManager
  class Application < Lotus::Application
    configure do
      ...
      #
      layout :application # It will load ImageManager::Views::ApplicationLayout
      ...
      # Configure the code that will yield each time ImageManager::Action is included
      ...
      # Configure the code that will yield each time ImageManager::View is included
      # This is useful for sharing common functionality
      #
      # See: http://www.rubydoc.info/gems/lotus-view#Configuration
      view.prepare do
        include Lotus::Helpers
        include ImageManager::Assets::Helpers
