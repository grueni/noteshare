...
module SessionManager
  class Application < Lotus::Application
    configure do
      ...
      #
      layout :application # It will load SessionManager::Views::ApplicationLayout
      ...
      #
      # Fixme: temporarily commeneted out by JC
      ...
      # Configure the code that will yield each time SessionManager::Action is included
      ...
      # Configure the code that will yield each time SessionManager::View is included
      # This is useful for sharing common functionality
      #
