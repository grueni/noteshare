...
module Uploader
  class Application < Lotus::Application
    configure do
      ...
      #
      layout :application # It will load Uploader::Views::ApplicationLayout
      ...
      #
      # Fixme commented out for testing by JC
      ...
      # Configure the code that will yield each time Uploader::Action is included
