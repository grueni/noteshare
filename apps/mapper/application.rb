...
module Mapper
  class Application < Lotus::Application
    configure do
      ...
      #
      layout :application # It will load Mapper::Views::ApplicationLayout
      ...
      # Configure the code that will yield each time Mapper::Action is included
      ...
      # Configure the code that will yield each time Mapper::View is included
      # This is useful for sharing common functionality
      #
